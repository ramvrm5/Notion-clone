        ...
        <div className="text-sm">
            <div className="flex items-center gap-x-1 p-2">
                ...
                <Input
                    ...
                    className="h-7 px-2 focus-visible:ring-transparent bg-secondaary"
                />
            </div>
            <div className="mt-2 px-1 pb-1">
                ...
                {filteredDocuments?.map((document) => (
                    <div
                        ...
                        className="text-sm rounded-sm w-ful hover:bg-primary/5 flex items-center text-primary justify-between"
                    >
